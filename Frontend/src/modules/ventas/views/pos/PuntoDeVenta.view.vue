<template>
  <section
    ...
    <header class="shrink-0 border-b border-slate-200 bg-white/95 px-4 py-2.5 backdrop-blur">
      <div class="flex flex-wrap items-center justify-between gap-3">
        <div class="min-w-0">
          ...
          <div class="mt-1.5 flex items-center gap-2.5">
            <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-600 shadow-sm shadow-blue-200/70">
              <i class="pi pi-shopping-bag text-sm text-white"></i>
            </div>

            <div class="min-w-0">
              <h1 class="truncate text-base font-bold text-slate-900">Punto de Venta</h1>
        ...
        <div class="flex shrink-0 flex-wrap items-center gap-2">
          <div class="hidden rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-1.5 md:block">
            <p class="text-[10px] font-semibold uppercase tracking-[0.14em] text-emerald-600">
              Caja
            </p>
    ...
    <div class="shrink-0 border-b border-slate-200 bg-white px-4 py-2.5">
      <div class="flex items-center gap-3">
        ...
        <button
          class="shrink-0 flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-600 transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700"
      ...
      <div class="flex min-h-0 h-full flex-1 overflow-hidden">
        <div class="pos-main-panel flex h-full min-h-0 flex-1 flex-col overflow-hidden bg-white">
          ...
          <div class="pos-carrito-scroll min-h-0 flex-1 overflow-y-auto overflow-x-hidden">
            <div v-if="carritoVacio" class="flex h-full flex-col items-center justify-center gap-3 py-10">
              <div class="flex h-16 w-16 items-center justify-center rounded-3xl bg-slate-100 shadow-inner">
        ...
        <aside
          class="pos-resumen-panel flex h-full min-h-0 w-[19rem] shrink-0 flex-col overflow-hidden border-l border-slate-200 bg-white xl:w-[20rem]">
          <div class="shrink-0 border-b border-slate-100 bg-gradient-to-b from-slate-50 to-white px-4 py-3">
          ...
          <div class="pos-resumen-scroll min-h-0 flex-1 overflow-y-auto px-4 py-3">
            ...
            <div class="space-y-2.5">
              <div class="rounded-2xl border border-slate-100 bg-slate-50/80 p-3">
                ...
                <div class="mt-1.5 flex items-center justify-between text-sm text-slate-600">
                  <span>Subtotal</span>
              ...
              <div
                ...
                <div class="flex items-start justify-between gap-3">
                  ...
                  <div
                    class="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-600 text-white shadow-md shadow-blue-200">
                    <i class="pi pi-wallet text-sm"></i>
                  </div>
                </div>

                <div class="mt-3 grid grid-cols-2 gap-2">
                  <div class="rounded-2xl bg-white/80 px-3 py-1.5">
                    <p class="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Productos</p>
                    <p class="mt-0.5 text-sm font-bold text-slate-800">{{ totalArticulos }}</p>
                  </div>
          ...
          <div class="shrink-0 border-t border-slate-100 p-3">
            <button :disabled="carritoVacio" class="premium-cobrar-btn group w-full" @click="dialogCobrar = true">
              ...
              <span class="flex min-w-0 flex-1 flex-col items-start text-left">
                <span class="text-[10px] font-semibold uppercase tracking-[0.14em] text-blue-100/90">
                  Cobrar ahora
                </span>
